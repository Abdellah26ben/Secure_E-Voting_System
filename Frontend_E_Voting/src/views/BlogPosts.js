...
class BlogPosts extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      PostsListOne: [
        {
          backgroundImage: require("../images/content-management/1.jpeg").default,
          category: "Business",
          categoryTheme: "dark",
          author: "Anna Kunis",
        ...
        {
          backgroundImage: require("../images/content-management/2.jpeg").default,
          category: "Travel",
          categoryTheme: "info",
        ...
        {
          backgroundImage: require("../images/content-management/3.jpeg").default,
          category: "Technology",
        ...
        {
          backgroundImage: require("../images/content-management/4.jpeg").default,
          category: "Business",
      ...
      PostsListTwo: [
        {
          backgroundImage: require("../images/content-management/5.jpeg").default,
          category: "Travel",
          categoryTheme: "info",
          author: "Anna Ken",
          authorAvatar: require("../images/avatars/0.jpg").default,
          title:
        ...
        {
          backgroundImage: require("../images/content-management/6.jpeg").default,
          category: "Business",
          categoryTheme: "dark",
          author: "John James",
          authorAvatar: require("../images/avatars/1.jpg").default,
      ...
      PostsListFour: [
        {
          backgroundImage: require("../images/content-management/7.jpeg").default,
        ...
        {
          backgroundImage: require("../images/content-management/8.jpeg").default,
          author: "Chris Jamie",
          authorUrl: "#",
          category: "News",
          categoryUrl: "#",
        ...
        {
          backgroundImage: require("../images/content-management/9.jpeg").default,
        ...
        {
          backgroundImage: require("../images/content-management/10.jpeg").default,
          author: "Monica Jordan",
          authorUrl: "#",
          category: "News",
          categoryUrl: "#",
